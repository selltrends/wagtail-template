...
class FeatureBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "gem"
        label = "Feature"
        template = "components/streamfields/features/feature_block.html"
...
class FeatureCategoryBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = (
            "components/streamfields/features/feature_category_block.html"
        )
...
class FeatureIndexBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/features/feature_index_block.html"
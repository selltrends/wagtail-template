...
from {{ project_name }}.core.choices import SVGIcon
...
class ComparisonTableBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "table"
        template = "components/streamfields/comparison_table_block/comparison_table_block.html"
...
class HeadlineBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "title"
        label = "Headline"
        template = "components/streamfields/headline/headline.html"
...
class HighlightBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        label = "Highlight"
        template = (
            "components/streamfields/highlight_block/highlight_block.html"
        )
...
class IconBulletBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        label = "Icon bullet"
        template = (
            "components/streamfields/icon_bullet_block/icon_bullet_block.html"
        )
...
class IconBulletsBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "components/streamfields/icon_bullets_list_block/icon_bullets_list_block.html"
        label = "Icon bullets"
...
class StandaloneQuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/quotes/standalone_quote_block.html"
...
class MultipleQuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/quotes/quotes.html"
...
class RichTextBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        label = "Rich text"
        template = (
            "components/streamfields/rich_text_block/rich_text_block.html"
        )
...
class StandaloneCTABlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/cta/cta.html"
        preview_value = {
            "cta": {
...
class TeaserBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/teaser_block/teaser_block.html"
...
class TextAndMediaBlock(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "components/streamfields/text_and_media_block/text_and_media_block.html"
...
class GetStartedItem(blocks.StructBlock):
    ...
    class Meta:
        template = "components/icon-link/icon-link.html"
...
class GetStartedBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "components/get-started/get-started.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "components/streamfields/video_block/video_block.html"
...
class ContentStoryBlock(blocks.StreamBlock):
    ...
    get_started_block = SnippetChooserBlock(
        ...
        icon="table-list",
        template="components/streamfields/get_started_block/get_started_block.html",
    )
    sign_up_form = SnippetChooserBlock(
        "core.SignupFormSnippet",
        icon="envelope-open-text",
        template="components/streamfields/sign_up_form_block/sign_up_form_block.html",
    )
    ...
    class Meta:
        template = "components/streamfields/content_story_block.html"
...
class HomePageStoryBlock(blocks.StreamBlock):
    ...
    class Meta:
        template = "components/streamfields/home_page_story_block.html"
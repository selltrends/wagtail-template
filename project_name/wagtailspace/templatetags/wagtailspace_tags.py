...
from {{ project_name }}.wagtailspace.models import SpaceMenu, SpaceScheduleLink


register = template.Library()


@register.inclusion_tag("includes/space_main.html", takes_context=True)
...
@register.inclusion_tag(
    "components/buttons/spacereg-button.html", takes_context=True
)

...
from {{ project_name }}.core.blocks import CTABlock, ImageBlock
from {{ project_name }}.navigation.models import NavigationSettings
from {{ project_name }}.utils.models import CrossPageMixin, SocialMediaMixin
from {{ project_name }}.wagtailspace.blocks import SpaceMenuSectionBlock, SpaceStoryBlock
...
class WagtailSpaceIndexPage(SocialMediaMixin, CrossPageMixin, Page):
    template = "pages/space_index_page/space_index_page.html"
...
class WagtailSpacePage(SocialMediaMixin, CrossPageMixin, Page):
    ...
    template = "pages/space_page/space_page.html"
    heading = models.TextField(verbose_name="Heading", blank=True)
...
class SpaceSchedulePage(SocialMediaMixin, CrossPageMixin, Page):
    parent_page_types = ["wagtailspace.WagtailSpaceIndexPage"]
    template = "pages/space_schedule_page/space_schedule_page.html"
    heading = models.TextField(verbose_name="Heading", blank=True)
    sub_heading = models.TextField(verbose_name="Sub heading", blank=True)
    body = StreamField(SpaceStoryBlock(), blank=True)

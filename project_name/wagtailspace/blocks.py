...
from {{ project_name }}.core.blocks import CTALinkMixin, RichTextBlock


class SpaceTextBlock(RichTextBlock):
    class Meta:
        template = "components/streamfields/space_text_block.html"
        label = "Text"


class CenteredSpaceTextBlock(RichTextBlock):
    class Meta:
        template = "components/streamfields/centered_space_text_block.html"
        icon = "title"
        label = "Centered Text"
...
class SpaceCTABlock(CTALinkMixin):
    ...
    class Meta:
        icon = "bullhorn"
        template = "components/streamfields/cta/cta_space.html"
        label = "CTA"
...
class SpeakerBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "components/streamfields/speaker_block/speaker_block.html"
...
class SpeakerHighlightBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "group"
        template = (
            "components/streamfields/speaker_highlight/speaker_highlight.html"
        )
...
class SponsorLogoBlock(blocks.StructBlock):
    ...
    class Meta:
        template = (
            "components/streamfields/sponsor_logo/sponsorlogo_block.html"
        )
...
class SponsorBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "components/streamfields/sponsor_block/sponsor_block.html"
...
class SponsorHighlightBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "pick"
        template = (
            "components/streamfields/sponsor_highlight/sponsor_highlight.html"
        )
...
class SpaceStoryBlock(blocks.StreamBlock):
    ...
    class Meta:
        template = "components/streamfields/space_story_block.html"

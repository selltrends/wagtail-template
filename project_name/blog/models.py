...
from {{ project_name }}.blog.blocks import BlogStoryBlock
from {{ project_name }}.taxonomy.models import Category
...
class BlogIndexPage(Page, SocialMediaMixin, CrossPageMixin):
    template = "pages/blog/blog_index_page.html"
...
class BlogPage(Page, SocialMediaMixin, CrossPageMixin):
    template = "pages/blog/blog_page.html"
    subpage_types = []

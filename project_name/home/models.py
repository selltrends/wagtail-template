...
from {{ project_name }}.core.blocks import ContentStoryBlock, CTABlock, HomePageStoryBlock
from {{ project_name }}.core.choices import SVGIcon
from {{ project_name }}.core.models import HeroMixin
...
class ContentPage(Page, HeroMixin, SocialMediaMixin, CrossPageMixin):
    template = "pages/content_page/content_page.html"
